...
private const val TEST_MODEL_ALLOW_LIST = """{"models":[{"name":"Gemma-4-E2B-it","modelId":"litert-community/gemma-4-E2B-it-litert-lm","modelFile":"gemma-4-E2B-it.litertlm","description":"Gemma 4 E2B for on-device inference via LiteRT-LM. Supports multi-modality input with up to 32K context length.","sizeInBytes":2583085056,"minDeviceMemoryInGb":8,"commitHash":"7fa1d78473894f7e736a21d920c3aa80f950c0db","llmSupportImage":false,"llmSupportAudio":false,"defaultConfig":{"topK":64,"topP":0.95,"temperature":1.0,"maxContextLength":32000,"maxTokens":4000,"accelerators":"gpu,cpu","visionAccelerator":"gpu"},"taskTypes":["llm_chat","llm_prompt_lab"],"bestForTaskTypes":["llm_chat","llm_prompt_lab"]},{"name":"Gemma-4-E2B-it-Abliterated","modelId":"krsnalyst/andro","modelFile":"modelthelasthope.litertlm","description":"Gemma 4 E2B Abliterated (lasthope build).","sizeInBytes":2556493824,"minDeviceMemoryInGb":8,"commitHash":"e6a682803d4f2ea4fbb13964aba221bc1e6b1ace","llmSupportImage":false,"llmSupportAudio":false,"defaultConfig":{"topK":64,"topP":0.95,"temperature":1.0,"maxTokens":1024,"accelerators":"cpu,gpu","visionAccelerator":"gpu"},"taskTypes":["llm_chat","llm_prompt_lab"],"bestForTaskTypes":["llm_chat","llm_prompt_lab"]}]}"""
