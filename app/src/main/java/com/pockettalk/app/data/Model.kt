...
data class Model(
   ...
   * - `com.pockettalk.app` for builds from the GitHub source.
   * - `com.pockettalk.app` for other builds (Play store, internal, etc).
   *
   ...
   *
   * /storage/emulated/0/Android/data/com.pockettalk.app/files/my_model/local_dir/
   *
